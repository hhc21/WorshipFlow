...
| LC-SAF-02 | iPad Pro | iPadOS / Safari | LTE/5G 테더링 | JPEG | 터치/펜슬 필기 | 곡 전환 + 필기 연속 10분 무중단 | first_error: 미수집<br>video: 미수집 | TODO |
...
| LC-SAF-06 | iPhone | iOS / Safari | LTE/5G | JPEG | 터치 필기 | 축소 화면에서도 필기 입력 정상 | first_error: 미수집<br>video: 미수집 | TODO |
